                ...
                <div key={professional.id} className={`rounded-2xl border p-4 ${professional.active ? 'border-slate-200 bg-slate-50' : 'border-amber-200 bg-amber-50'}`}>
                  ...
                  <div className="mt-3 grid gap-2 sm:grid-cols-4">
                    <button
                      ...
                      className="rounded-xl bg-blue-600 px-3 py-3 text-xs font-black text-white transition hover:bg-blue-700"
                    >
                      Editar
                    </button>
                    ...
                    {professional.active ? (
                      <button type="button" onClick={() => deactivateProfessional(professional.id)} className="rounded-xl border border-amber-200 bg-amber-50 px-3 py-3 text-xs font-black text-amber-700 transition hover:bg-amber-100">Quitar</button>
                    ) : (
